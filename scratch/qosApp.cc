...
private:
  ...
  uint32_t datarate_VI = 5000000; 
  uint64_t datarate_BE = 5000000000;
...
QoS::Initialize()
{
  ...
  mac.SetType ("ns3::ApWifiMac","Ssid", SsidValue (ssid),"QosSupported", BooleanValue (true), "BE_MaxAmpduSize", UintegerValue (32768), "BE_MaxAmsduSize", UintegerValue (3839) );//,"BE_MaxAmpduSize", UintegerValue (0));
...
QoS::InstantThroughput(double time)
{
  ...
  for (unsigned index = 0; index < sinkApplications.GetN (); ++index)
  {
      ...
      std::cout<< "packets: " << totalPacketsThrough/1472 <<std::endl;
      if(index==0)
      {
...
QoS::Run()
{
  ...
  {
    //Simulator::Schedule(Seconds(20), &QoS::AddApp,this,1,index, Seconds(20)); 
    //Simulator::Schedule(Seconds(40), &QoS::RemoveApp,this,1,index); 
  }
