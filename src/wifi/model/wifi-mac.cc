...
{
  //1000m
  return Seconds (3.0 / 300000000.0);//1000
}
...
WifiMac::GetDefaultCtsAckTimeout (void)
{
  ...
  */
  ...
  ctsTimeout += MicroSeconds (GetDefaultMaxPropagationDelay ().GetNanoSeconds () * 2);
...
WifiMac::GetDefaultBasicBlockAckTimeout (void)
{
  ...
  blockAckTimeout += NanoSeconds (GetDefaultMaxPropagationDelay ().GetNanoSeconds () * 2);
...
WifiMac::Configure80211ow (void)
{
  ...
  SetCtsTimeout (MicroSeconds (16 + 44 + 9 + 1));
  SetAckTimeout (MicroSeconds (16 + 44 + 9 + 1));*/

  SetSifs (NanoSeconds (160));
  SetSlot (NanoSeconds (90));
  SetEifsNoDifs (NanoSeconds (160 + 440));
  SetPifs (NanoSeconds (160 + 90));
  SetCtsTimeout (NanoSeconds (160 + 440 + 90 + GetDefaultMaxPropagationDelay ().GetNanoSeconds () * 2));
  SetAckTimeout (NanoSeconds (160 + 440 + 90 + GetDefaultMaxPropagationDelay ().GetNanoSeconds () * 2));
  
  
  /*SetSifs (MicroSeconds (2));
  SetSlot (MicroSeconds (1));
  SetEifsNoDifs (MicroSeconds (2 + 4));
  SetPifs (MicroSeconds (2 + 1));
  SetCtsTimeout (MicroSeconds (2 + 10 + 1 + 1));
  SetAckTimeout (MicroSeconds (2 + 10 + 1 + 1));
  */
}
